...
import { getLatestArticles, getPopularArticles, getArticleStats, convertToArticle } from '@/lib/database/articles'
import { getCategoryStats } from '@/lib/database/categories'

export default async function Home() {
  try {
    const [latestArticlesData, popularArticlesData, stats, categories] = await Promise.all([
      getLatestArticles(3),
            ...
            <div className="lg:col-span-3 space-y-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                <Link href="/category/fuzoku" className="research-card">
                  <div className="research-badge fuzoku mb-4">
                    風俗体験談
                  </div>
              ...
              {latestArticles.length > 0 && (
                <div className="content-card-elevated">
                  <div className="flex justify-between items-center mb-6">
                    ...
                    <Link href="/articles" className="font-medium hover:underline" 
