...
export default async function SidebarServer({ className = '' }: SidebarProps): Promise<React.JSX.Element> {
  try {
          ...
          <div className="space-y-3">
            <div className="p-3 rounded-lg" style={{ 
              ...
              <div className="flex items-center mb-2">
                <span className="text-xs font-medium" style={{ color: '#22c55e' }}>NEW</span>
                <span className="text-xs ml-2" style={{ color: 'var(--text-muted)' }}>2025.07.15</span>
              </div>
            ...
            <div className="p-3 rounded-lg" style={{ 
              ...
              <div className="flex items-center mb-2">
                ...
                <span className="text-xs ml-1" style={{ color: 'var(--text-muted)' }}>2025.07.10</span>
              </div>
              <p className="text-sm" style={{ color: 'var(--text-primary)' }}>
                サイトリニューアルが完了しました
              </p>
